      ...
      <div className="sheet">
        ...
        <div className="card-section">
          <Card>
            ...
            >
              <Bullet>
                A Management application for teachers to use in the classroom to
                assign groups and assess their students in different qualities
            ...
            >
              <Bullet>
                ...
                customization restrictions on a Windows machine and change their
                wallpaper.
              </Bullet>
            ...
            >
              <Bullet>
                A prototype social media mobile app like Instagram, Facebook and
                Reddit, where users can make posts and input upvotes and
            ...
            >
              <Bullet>
                A prototype mobile app for customers to book a table by viewing
                a graphical map of the restaurant.
              </Bullet>
            ...
            >
              <Bullet>
                Web Application for managing day to day business operations such
                as recording orders, managing clients, and tracking expenses.
              </Bullet>
          ...
          <Card>
            ...
            <Activity title="UniMelb Game Makers club, Production Division">
              <Bullet>
                Collaborating with teams to program games for the University of
                Melbourne Game Makers Club.
              </Bullet>
